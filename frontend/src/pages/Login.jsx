        ...
        <div style={{ padding: "0 16px 48px", marginTop: -32, position: "relative", zIndex: 10 }}>
          <div className="login-card" style={{ background: "#fff", borderRadius: 24, boxShadow: "0 8px 40px rgba(15,23,42,0.12)", overflow: "hidden" }}>
            ...
            <div style={{ padding: "24px 20px 28px" }}>
              <h2 style={{ fontFamily: "Sora,sans-serif", fontSize: 22, fontWeight: 800, color: "#0f172a", marginBottom: 4 }}>Login</h2>
              <p style={{ fontSize: 13, color: "#64748b", marginBottom: 16 }}>Sign in to manage your insurance & claims.</p>
              <FormBody {...formProps} />
            </div>
          </div>
        </div>
